...
import ProfileAllEventCard from '../../../components/ProfileAllEventCard';
...
export default function Participants() {
    return (
        <Layout>
            ...
            <PageTopSide responsiveTop="40" responsiveHeight="250" bgImage="./../../assets/images/homeBg.jpg" defaultHeight="250" title="Tüm Etkinlikler" desc="" />
                                        ...
                                        <Col xs={12}>
                                            <Form className="mt-4 ">
                                                <Form.Group controlId="formBasicEmail">
                                                    ...
                                                    <Form.Control type="email" placeholder="Etkinlik Ara." />
                                                </Form.Group>
                                            </Form>
                                        </Col>
                                        <Col xs={12} >
                                         <OrganizationEventCard  title="Career Talks #5" content="Herkese merhaba!
                    İstanbul Bilişim Topluluğu olarak “Career Talks” serimize hız kesmeden devam ediyoruz.Bu
                     hafta bize optiWisdom ‘un kurucusu Doç.Dr. Şadi Evren Şeker eşlik ediyor." img="imagesadi"/>
                                        </Col>
                                        <Col xs={12} >
                                         <OrganizationEventCard  title="Career Talks #5" content="Herkese merhaba!
                    İstanbul Bilişim Topluluğu olarak “Career Talks” serimize hız kesmeden devam ediyoruz.Bu
