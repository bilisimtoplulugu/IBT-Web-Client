...
.photoArea{
    border: 3px dashed rgba(46,62,72,.12);
    border-radius: 8px;
    height:200px;
    display:flex;
    align-items:center;
...
export default function addevent() {
    ...
    return (
        <Layout>
            <PageTopSide responsiveTop="50" responsiveHeight="200" bgImage="./../assets/images/homeBg.jpg" defaultHeight="250" title="Etkinlik Oluştur" desc="Topluluk Adı" />
                                    ...
                                    <CustomCard>
                                        ...
                                        <Form.Row>
                                            ...
                                            <div className="photoArea">
                                                   ...
                                                   {previewThumbnail &&  <div className="editButton">
