        ...
        <Container>
          <Row>
            <Col xs={12} md={6}>
              ...
              <p>
                İstanbul'da bulunan üniversite kulüplerince düzenlenecek olan
                bilişimle ilgili etkinliklerin paylaşıldığı ve bu etkinliklerin
                organize edildiği platformdur.
              </p>
            </Col>
            <Col xs={6}></Col>
          </Row>
